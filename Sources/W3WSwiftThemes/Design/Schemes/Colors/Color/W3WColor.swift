...
public class W3WColor {
  ...
  public let colors: [W3WColorMode: W3WCoreColor]  
  ...
  public func complimentaryTextColor() -> W3WColor {
    return W3WColor(light: self[.light].complimentaryTextColor(), dark: self[.dark].complimentaryTextColor())
  }
