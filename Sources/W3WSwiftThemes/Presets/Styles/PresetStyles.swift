...
extension W3WStyles {
  ...
  static public func buttonLarge(theme: W3WTheme? = .standard) -> W3WStyles { return W3WStyles(cornerRadius: .regular, font: .buttonLarge(theme: theme), padding: W3WPadding(top:  14.0, left: 16.0, bottom:  14.0, right: 16.0)) }
